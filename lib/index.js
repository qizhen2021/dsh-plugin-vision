...
import { applySeeTool } from "./see.js";
import { VISION_SETTINGS_NS, VisionSettingsSchema } from "./settings.js";
/**
...
export const Config = z.object(Object.fromEntries(Object.entries(DEFAULTS).map(([key, value]) => [key, schemaFor(value).default(value)])));
export function apply(ctx, config) {
    const resolved = { ...DEFAULTS, ...(config ?? {}) };
    const runtime = { defaultModel: resolved.defaultModel };
